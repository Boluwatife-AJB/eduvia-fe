...
interface StaffTableProps<TValue> {
...
export default function StaffTable<TValue>({
  columns,
  data,
  meta,
  itemsPerPage,
          ...
          {isLoading ? (
            ...
            table.getRowModel().rows.map((row) => (
              <TableRow
                ...
                onClick={
                  () => router.push(`/${tenant}/admin/staff/${row.original.id}`)
      ...
      <div className="flex w-full flex-wrap items-center justify-between gap-6 max-sm:justify-center px-6">
        ...
        <div className="text-muted-foreground flex grow items-center justify-end whitespace-nowrap max-sm:justify-center">
          ...
          >
            ...
            <span className="text-foreground">{meta.total}</span> staff
          </p>
        </div>
