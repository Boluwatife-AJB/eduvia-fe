...
import { ArrowRightIcon, EyeIcon, EyeSlashIcon, IdentificationCardIcon, LockKeyIcon } from "@phosphor-icons/react";
...
export default function SignInForm({ userType }: SignInFormProps) {
  ...
  const {formState:{isValid, isSubmitting }, control, handleSubmit} = form;
